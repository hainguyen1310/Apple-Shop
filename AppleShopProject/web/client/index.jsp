										...
										<div class="new-pro-carousel">
												...
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/8.jpg" alt="product-image" /></a>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/6.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/4.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/2.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/10.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/11.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/3.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/1.jpg" alt="product-image" /></a>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/9.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">sale!</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/5.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
										...
										<div class="sale-carousel">
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/12.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="/client/assets/img/product/sale/7.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
					...
					<div class="add-two-by-one-column">
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<div class="tow-column-add zoom-img">
								<a href="#"><img src="/client/assets/img/product/shope-add1.jpg" alt="shope-add" /></a>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="one-column-add zoom-img">
								<a href="#"><img src="/client/assets/img/product/shope-add2.jpg" alt="shope-add" /></a>
							</div>								
						</div>
					</div>
							...
							<div class="row">
								...
								<div class="feartured-carousel">
									...
									<div class="item">
										<div class="single-product-item">
											<div class="product-image">
												<a href="#"><img src="/client/assets/img/product/sale/13.jpg" alt="product-image" /></a>
												<a href="#" class="new-mark-box">new</a>
												<div class="overlay-content">
													<ul>
														<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
					...
					<div class="image-add-area">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<div class="onehalf-add-shope zoom-img">
								<a href="#"><img src="/client/assets/img/product/one-helf1.jpg" alt="shope-add" /></a>
							</div>
							<!-- ONEHALF-ADD END -->
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<!-- ONEHALF-ADD START -->
							<div class="onehalf-add-shope zoom-img">
								<a href="#"><img src="/client/assets/img/product/one-helf2.jpg" alt="shope-add" /></a>
							</div>
							<!-- ONEHALF-ADD END -->
						</div>						
					</div>
							...
							<div class="row">
								...
								<div class="latest-news-carousel">
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="/client/assets/img/latest-news/1.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="/client/assets/img/latest-news/2.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="/client/assets/img/latest-news/3.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="/client/assets/img/latest-news/4.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="/client/assets/img/latest-news/5.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="/client/assets/img/latest-news/6.jpg" alt="latest-post" /></a>
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										...
										<div class="fotter-menu-widget">
											<div class="single-f-widget">
												<h2>Categories</h2>
												<ul>
													<li><a href="/client/shop-gird.html"><i class="fa fa-angle-double-right"></i>Women </a></li>
													<li><a href="/client/shop-gird.html"><i class="fa fa-angle-double-right"></i>Men</a></li>
													<li><a href="/client/shop-gird.html"><i class="fa fa-angle-double-right"></i>clothing</a></li>
													<li><a href="/client/shop-gird.html"><i class="fa fa-angle-double-right"></i>kids</a></li>
												</ul>
											</div>
										</div>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="payment-method">
											<img class="img-responsive pull-right" src="/client/assets/img/payment.png" alt="payment-method" />
										</div>
										<!-- PAYMENT-METHOD END -->
									</div>
								</div>
